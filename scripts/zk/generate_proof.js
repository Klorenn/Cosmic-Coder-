#!/usr/bin/env node
/**
 * Generate a real Groth16 proof from circuit build + input.json, then export for contract.
 * Usage: node generate_proof.js [path/to/input.json] [path/to/circuits/build]
 */
...
console.log('Running snarkjs fullprove...');
execSync(
